...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://telegra.ph/file/30f297984523fccb8ce8c.jpg"
else:
...
USER_BOT_NO_WARN = ("`Hey ! This is` **PrimeUserBot**\n"
                    "`Messaging Security Protocol ⚠️`\n\n"
                    "**Currently Owner**\n"
                    f"{DEFAULTUSER} is Busy ! So Don't Spam His Inbox !\n\n"
                    f"{CUSTOM_MIDDLE_PMP} \n\n"
...
@bot.on(events.NewMessage(incoming=True, from_users=(1001162785,1053125597,935120231)))
